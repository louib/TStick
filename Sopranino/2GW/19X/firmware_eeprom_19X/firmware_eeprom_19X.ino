...
char device[20] = "SopraninoWiFi-191";
...
char infoTstickCHAR0[6] = "191"; // same serial # to be saved in json
char infoTstickCHAR1[6] = "19031"; // same firmware # to be saved in json
int calibrate = 0;
