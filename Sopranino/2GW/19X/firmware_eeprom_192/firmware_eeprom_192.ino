...
unsigned int infoTstick[2] = {192, 19051};    // serial number and firmware revision
char author[20] = "Mathias Bredholt"; // DON'T FORGET TO CHANGE ALSO IN WiFi.ino, LINE 132
