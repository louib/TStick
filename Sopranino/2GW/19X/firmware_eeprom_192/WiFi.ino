...
void Wifimanager_portal(char *portal_name, char *portal_password, bool shouldSaveConfig, bool WiFiSerialDebug) {
  ...
  WiFiManagerParameter custom_hint("<small>Original number: 192 (Mathias Bredholt)<br>*Hint: if you want to reuse the currently active WiFi credentials, leave SSID and Password fields empty</small>");
